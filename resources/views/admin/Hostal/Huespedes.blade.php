        ...
        <div class="card">
            ...
            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="#tabs-clientes" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">Clientes - Hostal</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="#tabs-cuentas-corrientes" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Clientes - Salon</a>
                </li>
            </ul>
            </div>
            <div class="card-body">
                                            ...
                                            <div class="row" style="background: #F5F7F8;">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row" style="padding-bottom: 10px">
                                                        <div class="col-md-6">            
                                                            <input class="form-control" placeholder="Filtrar Por Cliente" id="searchclientehostal" name="searchclientehostal" style="margin-bottom: 10px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-12" style="width: 100%; padding-top: 15px; margin: 0px;">
                                            ...
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <button id="cargar-mas-clientes" class="btn btn-primary">Cargar más</button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" style="width: 100%; background-color: #1d2736">
                            <div class="row" style="width: 100%;">
                                ...
                                <div class="col-12 col-sm-4" style="text-align: right;">
                                    <a class="btn" style="padding-left: 25px;" id="addclientessalon"> 
                                        + Cliente
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12" style="width: 100%; background: #F5F7F8; padding-top: 10px; padding-bottom: 10px">
                                            <div class="row" style="background: #F5F7F8;">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row" style="padding-bottom: 10px">
                                                        <div class="col-md-6">            
                                                            <input class="form-control" placeholder="Filtrar Por Cliente" id="searchclientesalon" name="searchclientesalon" style="margin-bottom: 10px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-12" style="width: 100%; padding-top: 15px; margin: 0px;">
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="card" style="height: 600px; overflow-y: scroll;">
                                                        <div class="table-responsive" id="tabla-clientes-salon">
                                                            <table class="table table-vcenter card-table">
                                                                <thead>
                                                                    <tr>
                                                                        <th>N¹</th>
...
<script src="{{ asset('utilidades/js/hostal/clienteshostal.js') }}" defer></script>
<script src="{{ asset('utilidades/js/hostal/clientessalones.js') }}" defer></script>
...
<style>
    ...
    #tabla-clientes-salon tbody tr:hover {
        background-color: #ffeeba;
    }
    #tabla-clientes-salon tbody tr.selected-row {
        background-color: #ffeeba;
    }
</style>
@livewireStyles
