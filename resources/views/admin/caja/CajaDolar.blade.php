<div class="card-header" style="width: 100%; background-color: #1d2736">
    <div class="row" style="width: 100%;">
        <div class="col-12 col-sm-8">
            <h3 class="card-title" style="color: white; font-weight: bold;">DOLAR</h3>
        </div>
        <div class="col-12 col-sm-4" style="text-align: right;">
            <button  id="addcajadolar" class="btn position-relative">
                Agregar
            </button>
        </div>
    </div>
                    ...
                    <div class="row" style="background: #F5F7F8;">
                        <div class="col-md-11">
                            <div class="row" style="padding-bottom: 10px">
                                <div class="col-md-3">
                                    <select name="DateCajaDolar" id="DateCajaDolar" class="form-control">
                                        <option value="DiarioCajaDolar">Diario</option>
                                        <option value="MensualidadCajaDolar">Todo El Mes</option>
                                        <option value="RangoCajaDolar">Rango</option>
                                    </select>
                                </div>
                                <div class="col-md-2" id="DiaCajaDolarContainer">
                                    <select name="DiaCajaDolar" id="DiaCajaDolar" class="form-control">
                                    </select>
                                </div>
                                <div class="col-md-3" id="MesCajaDolarContainer">
                                    <select name="MesCajaDolar" id="MesCajaDolar" class="form-control">
                                    </select>
                                </div>
                                <div class="col-md-3" id="AnioCajaDolarContainer">
                                    <select name="AnioCajaDolar" id="AnioCajaDolar" class="form-control">
                                    </select>
                                </div>
                                <div class="col-md-3" id="FechaInicioContainerCajaDolar">
                                    <input type="date" name="fechaInicioCajaDolar" id="fechaInicioCajaDolar" class="form-control">
                                </div>
                                <div class="col-md-3" id="FechaFinContainerCajaDolar">
                                    <input type="date" name="fechaFinCajaDolar" id="fechaFinCajaDolar" class="form-control">
                                </div><br><br><br>
                                <div class="col-md-11">
                                    <div class="input-group input-group-flat">
                                        <input type="text" name="searchcajadolar" id="searchcajadolar" class="form-control">
                        ...
                        <div class="col-md-1">
                            <div class="row" style="padding-bottom: 10px; text-align: end;">
                                <span class="badge bg-blue" style="padding: 10px; width: 50%; cursor: pointer;" id="btn-refrescar-tabla-dolar">
                                ...
                                <div class="row" style="width: 100%;">
                                    <div class="col-md-4" style="border-right: 2px solid #E6E6E6; border-bottom: 1px solid #E6E6E6; padding: 10px">
                                        <span style="color: #7F8487;">INGRESO <br>
                                            <span style="color: #2C3333; font-weight: bold; font-size: 22px" id="IngresoDolar"></span>
                                        </span>
                                    </div>
                                    <div class="col-md-4" style="border-bottom: 1px solid #E6E6E6; padding: 10px">
                                        <span style="color: #7F8487;">TOTAL <br>
                                            <span style="color: #2C3333; font-weight: bold; font-size: 22px" id="TotalDolar"></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="card">
                                <div class="table-responsive" style="overflow-y: scroll; max-height: 500px">
                                    <table class="table table-vcenter card-table" id="tabla-caja-Dolar">
...
<script>
    $(document).ready(function() { 
        FechaSelectCajaDolar()
        InputRangoFechasControl()

        $('#searchcajadolar').on('keyup', function() {
            var value = $(this).val().toLowerCase();
            $("#tabla-caja-Dolar tbody tr").filter(function() {
        ...
        document.getElementById('addcajadolar').addEventListener('click', function() {
            cargarArticulos();

            var formTabsDiv = document.getElementById('form_tabs');
            var formHtml = `
            <form id="form-register-detalle-dolar">
                <div class="card-header" style="background: rgb(24, 36, 51); color: white">
                    <h2 class="card-title">DOLAR</h2>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                ...
                <div class="card-footer">
                    <div class="d-flex" style="text-align: right">
                        ...
                        <button type="button" class="btn btn-primary" id="btn-registrar-detalle-dolar">GUARDAR</button>
                    </div>
                </div>
            </form>
            `;
            ...
            $('#btn-registrar-detalle-dolar').on('click', function(event) {
                event.preventDefault();
                var idCaja = {{ $idcaja }};

                var formData = {
                    articuloIdDolar: $('#articuloCajaSelect').val(),
                    detalle: $('#detalle').val(),
                ...
                $.ajax({
                    url: '/api/registrar-detalle-dolar',
                    method: 'POST',
                    data: formData,
                    success: function(response) {
                        MostrarMensaje("Registrado a Caja Dolar Exitosamente","success")
                        FiltrarDatosCajaDolar();
                        $('#detalle').val("")
                        $('#monto').val("")
                        $('#facturarecibo').val("")
                    },
        ...
        function MostrarCajaDolar(response) {
            var tbody = $('#tabla-caja-Dolar tbody');
            var formTabsDiv = $('#form_tabs');
            tbody.empty();
            $('#IngresoDolar').text(response.IngresoDolar);
            $('#TotalDolar').text(response.TotalDolar);
            
            response.cajadolars.forEach(function(item, index) {
                if(item.Eliminado == "false"){
                    if (item.articulocaja.id != 200 ) {
                        if(item.Ingreso > 0){
                            var row = `
                                <tr class="clickable-row-dolar" data-id="${item.id}" style="border-left: 3px solid green">
                                    <td>${index + 1}</td>
                            ...
                            var row = `
                                <tr class="clickable-row-dolar" data-id="${item.id}" style="border-left: 3px solid red">
                                    <td>${index + 1}</td>
                                    <td>${item.articulocaja.Codigo_caja}</td>
                                    <td>${item.codigocaja ? item.articulocaja.Nombre_Articulo : 'No disponible'}</td>
                                    <td>${item.Articulo_description}</td>
            ...
            $('.clickable-row-dolar').on('click', function() {
                $('.clickable-row-dolar').removeClass('selected-row');
                $(this).addClass('selected-row');
                var articuloIdDolar = $(this).data('id');
                $.ajax({
                    url: '/api/get-detalle-caja-dolar-select/' + articuloIdDolar,
                    method: 'GET',
                    success: function(response) {
                        ...
                        <form id="form-register-detalle-dolar">
                            <div class="card-header" style="background: rgb(24, 36, 51); color: white">
                                <div class="row" style="width: 100%;">
                                    ...
                                    <div class="col-12 col-sm-4" style="text-align: right;">
                                        <span id="editardetalledolar" class="badge bg-blue" data-id="${articuloIdDolar}" style="padding: 7px">Editar</span>
                                        <span id="eliminardetalledolar" class="badge bg-red" data-id="${articuloIdDolar}" style="padding: 7px">Eliminar</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 col-md-12">
                                                                    ...
                                                                    <div class="mb-12 row">
                                                                        ...
                                                                        <div class="col">
                                                                            <label class="col-8 col-form-label" style="color: #61677A">${response.consumo.FechaCierre}</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mb-12 row">
                                                                        <label class="col-4 col-form-label" style="font-weight: bold">Mesa</label>
                                                                        <div class="col">
                                                                            <label class="col-8 col-form-label" style="color: #61677A">Mesa # ${response.consumo.ambiente_mesa_id} </label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mb-12 row">
                        ...
                        $(document).on('click', '#editardetalledolar', function() {
                            var id = $(this).data('id');
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    var formHtml = `
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex" style="text-align: right">
                                                ...
                                                <button type="button" class="btn btn-primary" id="btn-update-detalle-dolar">GUARDAR</button>
                                            </div>
                                        </div>
                                    `;
                                    formTabsDiv.innerHTML = formHtml;
                                    ...
                                    $('#btn-update-detalle-dolar').on('click', function(event) {
                                        event.preventDefault();
                                        var idCaja = {{ $idcaja }};
                                        var iddetalle = id;

                                        var formData = {
                                            articuloIdDolar: $('#articuloCajaSelectUpdate').val(),
                                            detalle: $('#detalle').val(),
                                            facturarecibo: $('#facturarecibo').val(),
                                            tipoDeAccion: $('input[name="tipodeaccion"]:checked').val(),                    
                                            monto: $('#monto').val(),
                                        ...
                                        $.ajax({
                                            url: '/api/actualizar-caja-dolar',
                                            method: 'POST',
                                            data: formData,
                                            success: function(response) {
                                                console.log("se actualizo EXISITOSAMENTE")
                                                MostrarMensaje("Se actualizo EXISITOSAMENTE Exitosamente","success");
                                                FiltrarDatosCajaDolar();
                                                CanvasTime();
                                            },
                                            error: function(error) {
                        ...
                        $(document).on('click', '#eliminardetalledolar', function() {
                            var id = $(this).data('id');
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    var formHtml = `
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex" style="text-align: right">
                                                <button type="button" class="btn btn-primary" id="btn-eliminar-detalle-dolar">GUARDAR</button>
                                            </div>
                                        </div>
                                    `;
                                    formTabsDiv.innerHTML = formHtml;
                                    ...
                                    $('#btn-eliminar-detalle-dolar').on('click', function(event) {
                                        event.preventDefault();
                                        var idCaja = {{ $idcaja }};
                                        var iddetalle = id;
        ...
        function FechaSelectCajaDolar() {
            ...
            for (var month = 0; month < 12; month++) {
                $('#MesCajaDolar').append('<option value="' + (month + 1) + '">' + monthsOfYear[month] + '</option>');
            }
            $('#MesCajaDolar').val(currentMonth + 1);

            var startYear = currentYear - 6;
            var endYear = currentYear;
            for (var year = startYear; year <= endYear; year++) {
                $('#AnioCajaDolar').append('<option value="' + year + '">' + year + '</option>');
            }
            $('#AnioCajaDolar').val(currentYear);

            function updateDaySelectorNovedad() {
                var selectedMonth = parseInt($('#MesCajaDolar').val());
                var selectedYear = today.getFullYear();
                var daysInMonth = new Date(selectedYear, selectedMonth, 0).getDate();
                $('#DiaCajaDolar').empty();
                for (var day = 1; day <= daysInMonth; day++) {
                    $('#DiaCajaDolar').append('<option value="' + day + '">' + day + '</option>');
                }
                if (currentDay > daysInMonth) {
                    $('#DiaCajaDolar').val(daysInMonth);
                } else {
                    $('#DiaCajaDolar').val(currentDay);
                }
            }

            updateDaySelectorNovedad();

            $('#DateCajaDolar').on('change', function() {
                var selectedValue = $(this).val();
                switch (selectedValue) {
                    case 'DiarioCajaDolar':
                        $('#DiaCajaDolarContainer').show();
                        $('#AnioCajaDolarContainer').show();
                        $('#FechaInicioContainerCajaDolar').hide();
                        $('#FechaFinContainerCajaDolar').hide();
                        break;
                    case 'MensualidadCajaDolar':
                        $('#MesCajaDolarContainer').show();
                        $('#AnioCajaDolarContainer').show();
                        $('#DiaCajaDolarContainer').hide();
                        $('#FechaInicioContainerCajaDolar').hide();
                        $('#FechaFinContainerCajaDolar').hide();
                    break;
                    case 'RangoCajaDolar':
                        $('#DiaCajaDolarContainer').hide();
                        $('#MesCajaDolarContainer').hide();
                        $('#AnioCajaDolarContainer').hide();
                        $('#FechaInicioContainerCajaDolar').show();
                        $('#FechaFinContainerCajaDolar').show();
                    break;
                }
                FiltrarDatosCajaDolar();
            });
            ...
            $('#MesCajaDolar').on('change', function() {
                updateDaySelectorNovedad();
                FiltrarDatosCajaDolar();
            });

            $('#AnioCajaDolar').on('change', function() {
                FiltrarDatosCajaHostal();
            });

            $('#DiaCajaDolar').on('change', function() {
                FiltrarDatosCajaDolar();
            });

            $('#FechaInicioContainerCajaDolar').on('change', function() {
                FiltrarDatosCajaDolar();
            });

            $('#FechaFinContainerCajaDolar').on('change', function() {
                FiltrarDatosCajaDolar();
            });

            $('#DateCajaDolar').trigger('change');

        }

        function FiltrarDatosCajaDolar(){
            var today = new Date();
            var selectedYear = $('#AnioCajaDolar').val();
            var tipoFiltro = $('#DateCajaDolar').val();
            var dia = $('#DiaCajaDolar').val();
            var mes = $('#MesCajaDolar').val();
            var anio = selectedYear;
            var fechaInicio = $('#fechaInicioCajaDolar').val();
            var fechaFin = $('#fechaFinCajaDolar').val();
            var idCaja = {{ $idcaja }};

            $.ajax({
                url: '/api/filtrar-datos-caja-dolar',
                method: 'GET',
                data: {
        ...
        function InputRangoFechasControl(){
            ...
            var fechaInicioCajaDolar = document.getElementById('fechaInicioCajaDolar');
            var fechaFinCajaDolar = document.getElementById('fechaFinCajaDolar');
            fechaInicioCajaDolar.min = formatDate(firstDay);
            fechaInicioCajaDolar.max = formatDate(lastDay);
            fechaFinCajaDolar.min = formatDate(firstDay);
            fechaFinCajaDolar.max = formatDate(lastDay);
            fechaInicioCajaDolar.value = formatDate(today);
            fechaFinCajaDolar.value = formatDate(today);
        }
        ...
        document.getElementById("btn-refrescar-tabla-dolar").addEventListener("click", function() {
            FechaSelectCajaDolar()
        });
    });
</script>