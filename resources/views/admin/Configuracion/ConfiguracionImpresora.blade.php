                            ...
                            <div class="list-group card-list-group">
                                ...
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="text-muted">
                                        ...
                                        <a href="#" class="link-secondary btnImprimirPrueba" data-id="${response[0].id}">
                            ...
                            card.innerHTML = `
                                <div class="card">
                                    <div class="card-body text-center">
                                        <h3 class="card-title"><strong>${impresora.name}</strong></h3>
                                    ...
                                    <div class="card-footer" style="margin: 0px; padding: 0px">
                                        <button class="btn btn-primary" onclick="seleccionarImpresora('${impresora.name}')" style="width: 100%">Seleccionar impresora</button>
                                    </div>                                    
                                </div>
                            `;
                            impresorasContainer.appendChild(card);
