function OcupadoHabitacion(id) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            console.log("xD"+response.hospedajehabitacion[0].id)
            ...
            let datoscanal = '';
            let canales = response.hospedajehabitacion[0].reservas;

            if (canales.length > 0) {
                canales.forEach(function(canal) {
                    datoscanal += `
                        <span style="color: blue">${canal.CanalReserva || ''}</span>
                    `;
                });
            }
            ...
            var HabitacionForm = `
                <div class="card-header" style="width: 100%; background-color: #d63939; color: white">
                    <h3 class="card-title">Habitacion #${id} ${datoscanal}</h3>
                    <div class="ms-auto">
                        <span class="badge bg-azure-lt" data-id="${id}" id="ImprimirInformacionHospedaje" data-bs-toggle="modal" data-bs-target="#modalImprimirInformacionHospedaje" style="padding: 12px">
                                ...
                                <div class="tab-pane active show" id="tabs-hospedaje-habitacion" role="tabpanel">
                                    <div class="datagrid" style="background: white">
                                        <div class="row">                                            
                                            ...
                                            <div class="col-12 col-sm-12">
                                                <div class="card-header" style="width: 100%; background-color: #151f2c; color: white">
                                                    <h3 class="card-title">SERVICIOS 
                                                        <a href="#" style="color:#3FA2F6" data-id="${id}" id="ImprimirServiciosHospedaje" data-bs-toggle="modal" data-bs-target="#modalImprimirServiciosHospedaje">Imprimir</a>
                                                    </h3>
                                                    <div class="ms-auto">
                                            ...
                                            <div class="col-12 col-sm-12">
                                                <div class="card-header" style="width: 100%; background-color: #151f2c; color: white">  
                                                    <h3 class="card-title">CONSUMOS
                                                        <a href="#" style="color:#3FA2F6" data-id="${id}" id="ImprimirConsumosHospedaje" data-bs-toggle="modal" data-bs-target="#modalImprimirConsumosHospedaje">Imprimir</a>
                                                    </h3>
                                                    <div class="ms-auto">
                                                                            ...
                                                                            <div class="card">
                                                                                <div class="table-responsive">
                                                                                    ...
                                                                                    <tfoot>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="4" style="text-align: right;">Pagado:</td>
                                            ...
                                            <span>Puedes poner a deuda pendiente el pago de la 
                                                <a href="#" data-id="${hospedajeIdPrivate}" id="PendienteHospedaje" style="padding: 14px">
                                                    Habitacion
                                                </a>
                                            </span>
                                        </div>                                        
            ...
            $(document).on('click', '#ImprimirInformacionHospedaje', function() {
                const id = $(this).data('id');

                $.ajax({                    
                    url: '/apihostal/imprimir-informacion-hospedaje/'+id,
                    type: 'GET',
                    data: { id: id },
                    success: function(response) {
                        const pdfBase64 = response.pdfBase64;
                        $('#modalImprimirInformacionHospedaje .modal-body').html(`
                            <iframe src="data:application/pdf;base64,${pdfBase64}" width="100%" height="500px" style="border: none;"></iframe>
                        `);
                        $('#modalImprimirInformacionHospedaje').modal('show');
                    },
            ...
            $(document).on('click', '#ImprimirServiciosHospedaje', function() {
                const id = $(this).data('id');

                $.ajax({                    
                    url: '/apihostal/imprimir-servicios-hospedaje/'+id,
                    type: 'GET',
                    data: { id: id },
                    success: function(response) {
                        const pdfBase64 = response.pdfBase64;
                        $('#modalImprimirServiciosHospedaje .modal-body').html(`
                            <iframe src="data:application/pdf;base64,${pdfBase64}" width="100%" height="500px" style="border: none;"></iframe>
                        `);
                        $('#modalImprimirServiciosHospedaje').modal('show');
                    },
                    error: function(xhr, status, error) {
                        alert('Ocurrió un error al recuperar los datos.');
                        console.error(error);
            ...
            $(document).on('click', '#ImprimirConsumosHospedaje', function() {
                const id = $(this).data('id');

                $.ajax({                    
                    url: '/apihostal/imprimir-consumos-hospedaje/'+id,
                    type: 'GET',
                    data: { id: id },
                    success: function(response) {
                        const pdfBase64 = response.pdfBase64;
                        $('#modalImprimirConsumosHospedaje .modal-body').html(`
                            <iframe src="data:application/pdf;base64,${pdfBase64}" width="100%" height="500px" style="border: none;"></iframe>
                        `);
                        $('#modalImprimirConsumosHospedaje').modal('show');
                    },
                    error: function(xhr, status, error) {
                        alert('Ocurrió un error al recuperar los datos.');
                        console.error(error);
            ...
            $(document).on('click', '#BtnImprimirServicioDesayuno', function() {
                const id = $(this).data('id');

                $.ajax({                    
                    url: '/apihostal/imprimir-servicio-desayuno/'+id,
                    type: 'GET',
                    data: { id: id },
                    success: function(response) {
                        const pdfBase64 = response.pdfBase64;
                        $('#modalBtnImprimirServicioDesayuno .modal-body').html(`
                            <iframe src="data:application/pdf;base64,${pdfBase64}" width="100%" height="500px" style="border: none;"></iframe>
                        `);
                        $('#modalBtnImprimirServicioDesayuno').modal('show');
                    },
                    error: function(xhr, status, error) {
                        alert('Ocurrió un error al recuperar los datos.');
                        console.error(error);
            ...
            $(document).on('click', '#BtnImprimirConsumo', function() {
                const id = $(this).data('id');

                $.ajax({                    
                    url: '/apihostal/imprimir-consumo-hospedaje/'+id,
                    type: 'GET',
                    data: { id: id },
                    success: function(response) {
                        const pdfBase64 = response.pdfBase64;
                        $('#modalBtnImprimirConsumo .modal-body').html(`
                            <iframe src="data:application/pdf;base64,${pdfBase64}" width="100%" height="500px" style="border: none;"></iframe>
                        `);
                        $('#modalBtnImprimirConsumo').modal('show');
                    },
                    error: function(xhr, status, error) {
                        alert('Ocurrió un error al recuperar los datos.');
                        console.error(error);
            ...
            /*PONER EN PENDIENTE INICIO*/
            document.getElementById('PendienteHospedaje').addEventListener('click', function(event) {
                event.preventDefault();
                const dataId = this.getAttribute('data-id');
                Swal.fire({
                    title: "Estas seguro de poner en deuda el pago de la habitacion?",
                    text: "una vez puesto a deuda no abra vuelta atras",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: "#3085d6",
                    cancelButtonColor: "#d33",
                    ...
                    if (result.isConfirmed) {                       
                        $.ajax({
                            url: '/apihostal/pendiente-habitacion-hospedaje/' + dataId,
                            type: 'GET',
                            dataType: 'json',
                            success: function(response) {
                                MostrarHabitaciones();
                                ...
                                CanvasTime();
                                MostrarMensaje("Hospedaje Deuda Pendiente Exitosamente", "success")
                            },
                            error: function(error) {
                        ...
                        Swal.fire({
                            title: "Confirmado!",
                            text: "El pago de la habitacion se puso en deuda pendiente.",
                            icon: "success"
                        });
                    } else {
                        ...
                        if (detalle.TipoServicio === "Desayuno") {
                            ...
                            var fila = `
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" id="BtnImprimirServicioDesayuno" style="color:#3FA2F6" data-id="${detalle.id}" data-bs-toggle="modal" data-bs-target="#modalBtnImprimirServicioDesayuno">
                                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-printer"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 17h2a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h2" /><path d="M17 9v-4a2 2 0 0 0 -2 -2h-6a2 2 0 0 0 -2 2v4" /><path d="M7 13m0 2a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2v4a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2 -2z" /></svg>
                                        </a>
                                    </td>
                                    <td>
            ...
            hospedaje.servicioconsumos.forEach(function(servicioconsumo) {
                servicioconsumo.consumo.forEach(function(dataconsumo) {
                    ...
                    var fila = `
                        <tr>
                            <td>
                                <a href="#" id="BtnImprimirConsumo" style="color:#3FA2F6" data-id="${dataconsumo.id}" data-bs-toggle="modal" data-bs-target="#modalBtnImprimirConsumo">
                                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-printer"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 17h2a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h2" /><path d="M17 9v-4a2 2 0 0 0 -2 -2h-6a2 2 0 0 0 -2 2v4" /><path d="M7 13m0 2a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2v4a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2 -2z" /></svg>
                                </a>
                            </td>
