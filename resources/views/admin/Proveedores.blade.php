        ...
        <div class="card">
            ...
            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="#tabs-proveedores" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">Proveedores</a>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content">
                <div class="tab-pane active show" id="tabs-proveedores" role="tabpanel">
                    <div class="card">
                        <div class="card-header" style="width: 100%; background-color: #1d2736">
                            <div class="row" style="width: 100%;">
                                <div class="col-12 col-sm-8">
                                    <h3 class="card-title" style="color: white; font-weight: bold;">PROVEEDORES</h3>
                                </div>
                                <div class="col-12 col-sm-4" style="text-align: right;">
                                    <a class="btn" id="addproveedor" style="padding-left: 25px;">
                                        + Nuevo Proveedor   
                                    </a>
                                </div>                                
                            </div>
                                            ...
                                            <div class="row" style="background: #F5F7F8;">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row" style="padding-bottom: 10px">
                                                        <div class="col-md-6">            
                                                            <input class="form-control" placeholder="Filtrar Por Proveedor" id="searchproveedor" name="searchproveedor" style="margin-bottom: 10px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="card" style="height: 400px; overflow-y: scroll;">
                                                        <div class="table-responsive" id="tabla-proveedores">
                ...
                <div class="card">
                        <div class="card-header" style="width: 100%; background-color: #1d2736">
                            <div class="row" style="width: 100%;">
                                ...
                                <div class="col-12 col-sm-4" style="text-align: right;">
                                    <a class="btn" id="addcuentaproveedor">+ Nuevo Cuenta</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12" style="width: 100%; background: #F5F7F8; padding-top: 10px; padding-bottom: 10px">
                                            <div class="row" style="background: #F5F7F8;">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="row" style="padding-bottom: 10px">
                                                        <div class="col-md-6">                                                            
                                                            <select class="form-control" name="SelectProveedor" id="SelectProveedor">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-12" style="width: 100%; padding-top: 15px; margin: 0px;">
                                            <div class="row">
                                                <div class="col-12 col-sm-12">
                                                    <div class="card">
                                                        <div class="table-responsive" id="tabla-cuenta-proveedores">
                                                            <table class="table table-vcenter card-table">
                                                                <thead>
                                                                    <tr>
                                                                    <th>Proveedor</th>
...
<div class="modal modal-blur fade" id="modal-delete-cuenta-proveedor" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="w-100">
                ...
                <div class="col"><a href="#" class="btn btn-danger w-100" data-bs-dismiss="modal" id="confirmDeleteBtnCuentaProveedor">
                    Borrar
                    </a></div>
                </div>
            </div>
...
<script src="{{ asset('utilidades/js/proveedor.js') }}" defer></script>
<script src="{{ asset('utilidades/js/cuentacorrienteproveedor.js') }}" defer></script>

<style>
    #tabla-proveedores tbody tr:hover {
        background-color: #ffeeba;
    }
    #tabla-proveedores tbody tr.selected-row {
        background-color: #ffeeba;
    }

    #tabla-cuenta-proveedores tbody tr:hover {
        background-color: #ffeeba;
    }
    #tabla-cuenta-proveedores tbody tr.selected-row {
        background-color: #ffeeba;
    }
</style>
@livewireStyles
